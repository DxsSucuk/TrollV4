...
public class Language {
	...
	public void loadSingapore() {
		...
		addMessage("sg", "gui.anvils.on", "Landasan sekarang jatuh pada pemain &c[PLAYER]&2!");
		addMessage("sg", "gui.anvils.off", "Landasan tidak lagi jatuh pada pemain &c[PLAYER]&2!");
		addMessage("sg", "gui.cows", "Sapi agresif sekarang menyerang &c[PLAYER]&2!");
		addMessage("sg", "gui.giorno.on", "Giorno Giovanna sekarang menyerang &c[PLAYER]&2!");
		addMessage("sg", "gui.giorno.off", "Giorno Giovanna sekarang pergi &c[PLAYER] &2sendirian!");
		addMessage("sg", "gui.spooky.on", "Pemain &c[PLAYER] &2sekarang ada di Alam Bayangan!");
		addMessage("sg", "gui.spooky.off", "Pemain &c[PLAYER] &2tidak lagi berada di alam Bayangan!");
		addMessage("sg", "gui.endcredits", "Pemain &c[PLAYER] &2sekarang melihat kredit akhir!");
