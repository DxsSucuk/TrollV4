...
public class InvManager {
    ...
    public static void setPageOneTrolls(Inventory inv) {
    ...
    public static void openMLGchoiceInv(Player p) {
    ...
    public static void openItemInv(Player p) {
    ...
    public static void openTrollInv(Player p, Player victim) {
